      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {liveEvent && (
          <Link
            ...
            className="mb-8 flex w-fit items-center gap-3 rounded-sm border border-wwc-red/40 bg-wwc-red/10 px-4 py-2 text-sm font-semibold text-wwc-white transition-colors hover:bg-wwc-red/20"
          >
            <LiveBadge />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative hidden aspect-[3/4] w-full max-w-md justify-self-end overflow-hidden rounded-md border border-wwc-grey-800 lg:block">
